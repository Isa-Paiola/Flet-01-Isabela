...
def main(page: ft.Page):
    ...
    O parâmetr 'page' representa a tela/página do nosso app.
    """

    # Configurações básicas da página
    page.title = "Meu Primeiro App Flert" # Título que aparece na aba do navegador
    ...
    # Vamos adicionar mais alguns elementos para tornar mais inreressante
    page.add(
